...
```bash
curl -fsSL https://jev-pg-dvft.sprites.app/install.sh | sh
```
...
Needs Go 1.23+ and a C compiler: the Postgres parser is compiled from libpg_query. The first build takes about a minute.
