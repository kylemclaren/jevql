...
`jevql serve` runs the same executor as the CLI behind a tiny JSON API on localhost. The TypeScript and Python SDKs use it for long-running processes: one connection, one warm cache.
