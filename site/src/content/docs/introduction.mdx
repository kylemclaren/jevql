...
jevql is a psql-shaped command line client for PostgreSQL that understands one extra family of SQL functions:
...
The same engine is available as libraries. Go links it in process; TypeScript and Python talk to a local `jevql serve` or spawn the binary.
